...
class German(data.Dataset):
    def __init__(self, root=r'../data/german',
                 dataset = "german",
                 sens_attr = "Gender",
                 sens_idx = 0,
    ...
    def check_files(self):
        adj, features, labels, idx_train, idx_val, idx_test, sens = self.load_german(self.dataset, self.sens_attr,
    ...
    def load_german(self, dataset, sens_attr="Gender", predict_attr="GoodCustomer", path="../dataset/german/", label_number=1000):
    ...
    #
        ...
        if os.path.exists(f'{path}/{dataset}_edges.txt'):
            ...
            edges_unordered = self.build_relationship(idx_features_labels[header], thresh=0.8)
